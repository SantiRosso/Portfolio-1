...
const username = "SantiRosso"; // EDITAR - Cambialo por tu nombre de usuario de Github.
const maxPages = 1;
...
const displayRepos = function (repos) {
  for (const repo of repos) {
    ...
    listItem.innerHTML = `
            <a href="${
              repo.html_url
            }"><img src="https://opengraph.githubassets.com/1/${username}/${
      repo.name
    }"></a>
            <span class="repos__text">" ${repo.description} "</span> <br/><br/>
            <span class="repos__text">${devicons[repo.language]}</span> <br />
            <br />
            <a class="repos__button" href="${
              repo.html_url
            }" target="_blank">Ver Proyecto <i class="ri-arrow-right-up-line"></i></a> <br />
            <br />`;
